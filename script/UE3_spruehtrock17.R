...
desParam$reduce<-1
desParam$vorz<- -1
DLdesign<-fetchDesign(4,VsAndWs$VRES,VsAndWs$WRES,dataList,infosFromU$u_low,infosFromU$u_high,DLFsettings$x_low,DLFsettings$x_high,VsAndWs$u_roles,VsAndWs$x_roles,test_eqpr,desType,desParam,debug = 1)
